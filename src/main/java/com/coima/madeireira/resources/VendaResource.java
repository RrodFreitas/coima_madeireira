...
import com.coima.madeireira.services.VendaService;
...
public class VendaResource {
	...
	public ResponseEntity<Page<VendaDTO>> findAll(
			@RequestParam(value = "produtoId", defaultValue = "0") Long produtoId,
			Pageable pageable) {
		
		Page<VendaDTO> list = service.findAllPaged(produtoId, pageable);		
